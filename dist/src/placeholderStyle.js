...
function mapRules(selector, style) {
  var styles = { 0: style };
  if (style[':hover']) {
    styles = Object.assign({}, styles, { ':hover': style[':hover'] });
    delete styles[0][':hover'];
  }

  if (style[':active']) {
    styles = Object.assign({}, styles, { ':active': style[':active'] });
    delete styles[0][':active'];
  }

  if (style[':focus']) {
    styles = Object.assign({}, styles, { ':focus': style[':focus'] });
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        Object.assign({ 'data-reactdesktopid': this._id }, props),
        children,
...
//# sourceMappingURL=placeholderStyle.js.map