...
var Checkbox = (_dec = (0, _ValueRef2.default)(), _dec2 = (0, _hidden2.default)(), _dec3 = (0, _windows.ColorContext)(), _dec4 = (0, _windows2.ThemeContext)(), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _radium2.default)(_class = function (_Component) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      var componentStyle = Object.assign({}, _windows4.default.checkbox);
      var checkedStyle = { display: 'none' };
      var textStyle = Object.assign({}, _windows4.default.text);

      if (this.context.theme === 'dark') {
        componentStyle = Object.assign({}, componentStyle, _windows4.default.checkboxDark);
        textStyle = Object.assign({}, textStyle, _windows4.default.textDark);
      }

      if (this.state.checked) {
        checkedStyle = _windows4.default.svg;
        componentStyle = Object.assign({}, componentStyle, this.context.theme === 'dark' ? _windows4.default['checkboxDark:checked'] : _windows4.default['checkbox:checked']);
      ...
      if ((0, _radium.getState)(this.state, null, ':active')) {
        componentStyle = Object.assign({}, componentStyle, this.context.theme === 'dark' ? _windows4.default['checkboxDark:active'] : _windows4.default['checkbox:active']);
      } else if ((0, _radium.getState)(this.state, null, ':hover')) {
        componentStyle = Object.assign({}, componentStyle, this.context.theme === 'dark' ? _windows4.default['checkboxDark:hover'] : _windows4.default['checkbox:hover']);
      }

      return _react2.default.createElement(
        'div',
        { style: Object.assign({}, _windows4.default.container, style) },
...
Checkbox.propTypes = Object.assign({}, _hidden.hiddenPropTypes, _windows.colorPropTypes, _windows2.themePropTypes, {
  /**
...
Checkbox.contextTypes = Object.assign({}, _windows.colorContextTypes, _windows2.themeContextTypes);
