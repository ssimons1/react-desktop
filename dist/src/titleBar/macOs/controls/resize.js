...
var Resize = (_dec = (0, _windowFocus2.default)(), _dec(_class = (0, _radium2.default)(_class = function (_Component) {
  ...
  _createClass(Resize, [{
    ...
    value: function render() {
      ...
      var iconStyle = Object.assign({}, _2.default.resize.icon, {
        opacity: showIcon ? 1 : 0
      });

      var componentStyle = Object.assign({}, _2.default.resize.button, style);
      if (!isWindowFocused && !showIcon) {
        componentStyle = Object.assign({}, componentStyle, _2.default.resize.unfocused);
      }
