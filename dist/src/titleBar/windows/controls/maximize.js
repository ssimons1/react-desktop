...
var Maximize = (_dec = (0, _windowFocus2.default)(), _dec(_class = (0, _radium2.default)(_class = function (_Component) {
  ...
  _createClass(Maximize, [{
    ...
    value: function render() {
      ...
      var componentStyle = Object.assign({}, styles.button, style);
      if (this.context.theme === 'dark' || this.context.background && (0, _color.isDarkColor)(this.context.background)) {
        svgFill = '#ffffff';
        componentStyle = Object.assign({}, componentStyle, styles.buttonColorBackground);
      }
...
Maximize.contextTypes = Object.assign({}, _windows.themeContextTypes, _windows2.backgroundContextTypes, {
