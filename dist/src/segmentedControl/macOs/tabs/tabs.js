  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      for (var i = 0, len = children.length; i < len; ++i) {
        ...
        if (i === 0) props = Object.assign({}, props, { firstChild: true });
        if (i === len - 1) props = Object.assign({}, props, { lastChild: true });
      ...
      for (var _i = 0, _len = tabs.length; _i < _len; ++_i) {
        if (afterSelected) {
          tabs[_i] = Object.assign({}, tabs[_i], { afterSelected: true });
          afterSelected = false;
        }
        if (tabs[_i].selected) {
          afterSelected = true;
      ...
      if (prevSelectedIndex >= 0 && tabs[prevSelectedIndex]) tabs[prevSelectedIndex] = Object.assign({}, tabs[prevSelectedIndex], { prevSelected: true });

      return _react2.default.createElement(
        'div',
        { style: Object.assign({}, _2.default.tabs, style) },
