...
var Radio = (_dec = (0, _ValueRef2.default)(), _dec2 = (0, _hidden2.default)(), _dec3 = (0, _windows4.ColorContext)(), _dec4 = (0, _windows3.ThemeContext)(), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _radium2.default)(_class = function (_Component) {
  ...
  _createClass(Radio, [{
    ...
    value: function render() {
      ...
      var componentStyle = Object.assign({}, _windows2.default.radio, this.context.theme === 'dark' ? _windows2.default['radioDark'] : {});
      var labelStyle = _windows2.default.label;
      var circleStyle = Object.assign({}, _windows2.default.circle, this.context.theme === 'dark' ? _windows2.default['circleDark'] : {});
      ...
      if ((0, _radium.getState)(this.state, null, ':active')) {
        if (this.state.checked) {
          componentStyle = Object.assign({}, componentStyle, _windows2.default['radio:checked:active'], this.context.theme === 'dark' ? _windows2.default['radioDark:checked:active'] : {});
          circleStyle = Object.assign({}, circleStyle, _windows2.default['circle:active'], this.context.theme === 'dark' ? _windows2.default['circleDark:active'] : {});
        } else {
          componentStyle = Object.assign({}, componentStyle, _windows2.default['radio:active'], this.context.theme === 'dark' ? _windows2.default['radioDark:active'] : {});
        }
      } else if ((0, _radium.getState)(this.state, null, ':hover')) {
        if (this.state.checked) {
          circleStyle = Object.assign({}, circleStyle, _windows2.default['circle:hover'], this.context.theme === 'dark' ? _windows2.default['circleDark:hover'] : {});
        } else {
          componentStyle = Object.assign({}, componentStyle, _windows2.default['radio:hover'], this.context.theme === 'dark' ? _windows2.default['radioDark:hover'] : {});
        }
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _text2.default,
            { style: Object.assign({}, _windows2.default.text, this.context.theme === 'dark' ? _windows2.default.textDark : {}) },
            label
          )
        )
      );
...
Radio.propTypes = Object.assign({}, _hidden.hiddenPropTypes, _windows4.colorPropTypes, _windows3.themePropTypes, {
  /**
...
Radio.contextTypes = Object.assign({}, _windows3.themeContextTypes, _windows4.colorContextTypes);
