...
var Text = (_dec = (0, _macOs2.default)(), _dec2 = (0, _alignment2.default)(), _dec3 = (0, _margin2.default)(), _dec4 = (0, _padding2.default)(), _dec5 = (0, _fontSize2.default)(), _dec6 = (0, _dimension2.default)(), _dec7 = (0, _textAlign2.default)(), _dec8 = (0, _hidden2.default)(), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = _dec7(_class = _dec8(_class = function (_Component) {
  ...
  _createClass(Text, [{
    ...
    value: function render() {
      ...
      var componentStyle = Object.assign({}, _2.default.text, { color: color });
      if (bold && bold === true) {
        componentStyle = Object.assign({}, componentStyle, { fontWeight: 'bold' });
      } else if (bold) {
        componentStyle = Object.assign({}, componentStyle, { fontWeight: bold });
      }
  ...
  return Text;
}(_react.Component)) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class);
Text.propTypes = Object.assign({}, _padding.paddingPropTypes, _alignment.alignmentPropTypes, _macOs.backgroundPropTypes, _hidden.hiddenPropTypes, _textAlign.textAlignPropTypes, _margin.marginPropTypes, _fontSize.fontSizePropTypes, _dimension.dimensionPropTypes, {
  /**
