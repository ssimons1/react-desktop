...
var Text = (_dec = (0, _margin2.default)(), _dec2 = (0, _padding2.default)(), _dec3 = (0, _alignment2.default)(), _dec4 = (0, _hidden2.default)(), _dec5 = (0, _windows2.default)(), _dec6 = (0, _dimension2.default)(), _dec7 = (0, _windows4.ThemeContext)(), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = _dec7(_class = function (_Component) {
  ...
  _createClass(Text, [{
    ...
    value: function render() {
      ...
      var componentStyle = Object.assign({}, _windows6.default.text);

      color = color === true ? this.context.color : color ? color : '#000000';
      if (color) componentStyle = Object.assign({}, componentStyle, { color: color });else if (this.context.theme === 'dark') componentStyle = Object.assign({}, componentStyle, { color: '#ffffff' });
...
Text.propTypes = Object.assign({}, _windows4.themePropTypes, _margin.marginPropTypes, _padding.paddingPropTypes, _alignment.alignmentPropTypes, _hidden.hiddenPropTypes, _windows.backgroundPropTypes, _dimension.dimensionPropTypes, {
  /**
...
Text.contextTypes = Object.assign({}, _windows3.colorContextTypes, _windows4.themeContextTypes);
