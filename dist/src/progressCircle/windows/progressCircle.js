...
var ProgressCircle = (_dec = (0, _windows.ColorContext)(), _dec(_class = function (_Component) {
  ...
  _createClass(ProgressCircle, [{
    ...
    value: function render() {
      ...
      var containerStyle = Object.assign({}, _windows3.default.container);
      var componentStyle = Object.assign({}, _windows3.default.progress, style, {
        visibility: !hidden ? 'visible' : 'hidden',
        display: !hidden ? 'block' : 'none'
      });

      if (absolute) {
        componentStyle = Object.assign({}, componentStyle, _windows3.default.absolute);
      }
...
ProgressCircle.propTypes = Object.assign({}, _hidden.hiddenPropTypes, _windows.colorPropTypes, {
...
ProgressCircle.contextTypes = Object.assign({}, _windows.colorContextTypes);
