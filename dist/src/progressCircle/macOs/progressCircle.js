...
var ProgressCircle = function (_Component) {
  ...
  _createClass(ProgressCircle, [{
    ...
    value: function render() {
      ...
      var containerStyle = Object.assign({}, _2.default.container);
      var componentStyle = Object.assign({}, _2.default.progress, style, {
        visibility: !hidden ? 'visible' : 'hidden',
        display: !hidden ? 'block' : 'none'
      });

      if (absolute) {
        componentStyle = Object.assign({}, componentStyle, _2.default.absolute);
      }
...
ProgressCircle.propTypes = Object.assign({}, _hidden.hiddenPropTypes, {
